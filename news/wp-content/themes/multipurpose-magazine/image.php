...
<div class="container">
    <main id="maincontent" role="main" class="main-wrap-box">
        ...
        if($multipurpose_magazine_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                            ...
                            <div class="entry-content">
                                ...
                                <div class="entry-attachment">
                                    <div class="attachment">
                                        <?php multipurpose_magazine_the_attached_image(); ?>
                                    </div>
                                ...
                                <?php
                                    the_content();
                                    wp_link_pages( array(
                                        'before' => '<div class="page-links">' . __( 'Pages:', 'multipurpose-magazine' ),
                                        'after'  => '</div>',
                                    ) );
                                ?>
                            </div>    
                            <?php edit_post_link( __( 'Edit', 'multipurpose-magazine' ), '<footer role="contentinfo" class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
        ...
        <?php }else if($multipurpose_magazine_left_right == 'Right Sidebar'){ ?>
            <div class="row">
                <div class="col-lg-9 col-md-9" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
