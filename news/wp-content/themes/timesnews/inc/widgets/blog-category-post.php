 ...
 */
 ...
 class TimesNews_blog_category_posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_blog_category_posts', 'description' => esc_html__( 'Display single blog column in home page', 'timesnews') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct( false, $name=esc_html__('T-Spiral: Blog Category Posts','timesnews'), $widget_ops, $control_ops );
	}
