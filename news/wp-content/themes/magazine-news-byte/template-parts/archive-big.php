 ...
 * Archive Post Style: Big Thumbnail
 */
?>
...
<article <?php hoot_attr( 'post', '', 'archive-big' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'magnb_archive_imgsize', '', 'big' );
		...
		<div class="entry-grid-content hgrid-span-12">
			...
			<?php hoot_display_meta_info( hoot_get_mod('archive_post_meta'), 'archive-big' ); ?>
