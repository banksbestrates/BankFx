 ...
 * Archive Post Style: Mixed-Block3
 */
...
<article <?php hoot_attr( 'post', '', 'archive-mixed archive-mixed-block3 mixedunit-big' ); ?>>
...
<article <?php hoot_attr( 'post', '', 'archive-mixed archive-mixed-block3 mixedunit-block3 hcolumn-1-3' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'magnb_archive_imgsize', 'hoot-large-thumb', 'mixedblock3' );
		hoot_post_thumbnail( 'entry-content-featured-img entry-grid-featured-img', $img_size, true, esc_url( get_permalink() ) ); ?>
		...
		<div class="entry-grid-content">
			...
			<div class="screen-reader-text" itemprop="datePublished" itemtype="https://schema.org/Date"><?php echo get_the_date('Y-m-d'); ?></div>
			<?php hoot_display_meta_info( hoot_get_mod('archive_post_meta'), 'mixedunit-block3' ); ?>
