 ...
 * Archive Post Style: Block2
 */
?>

<article <?php hoot_attr( 'post', '', 'archive-block archive-block2 hcolumn-1-2' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'magnb_archive_imgsize', 'hoot-large-thumb', 'block2' );
		...
		<div class="entry-grid-content">
			...
			<?php hoot_display_meta_info( hoot_get_mod('archive_post_meta'), 'archive-block2' ); ?>
