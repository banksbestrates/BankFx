...
<?php if ( !(textwp_get_option('hide_tags_title')) ) { ?>
<div class="textwp-page-header-outside">
<header class="textwp-page-header">
<div class="textwp-page-header-inside">
<?php the_archive_title( '<h1 class="page-title">', '</h1>' ); ?>
<?php if ( !(textwp_get_option('hide_tags_description')) ) { ?><?php the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?><?php } ?>
</div>
</header>
</div>
<?php } ?>
