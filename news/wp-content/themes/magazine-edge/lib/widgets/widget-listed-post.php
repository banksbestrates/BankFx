...
// register magazine_edge_Listed_Post widget
function magazine_edge_register_listed_post_widget() {
    register_widget( 'magazine_edge_Listed_Post' );
}
add_action( 'widgets_init', 'magazine_edge_register_listed_post_widget' );
 
 /**
 * Adds magazine_edge_Listed_Post widget.
 */
class magazine_edge_Listed_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'magazine_edge_listed_post', // Base ID
			esc_html__( 'Magazine-Edge: Listed Post', 'magazine-edge' ), // Name
...
} // class magazine_edge_Listed_Post 