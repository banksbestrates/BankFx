...
$test_mode = array(
	...
	'tooltip'    => esc_attr__( 'If test mode is enabled, the popup will show for admin only', $this->plugin['text'] ),
);

$status_mode = array(
	'label'   => esc_attr__( 'Activated', $this->plugin['text'] ),
	'attr'    => [
		'name'  => 'status',
		'id'    => 'status',
		'value' => $status,
	],
	'tooltip'    => esc_attr__( 'If check - the popup will show on the frontend. If uncheck - popup not displayed on the frontend.', $this->plugin['text'] ),
);
                    ...
                    <div id="titlewrap">
                        ...
                        <div class="field has-addons">
                            <div class="control is-expanded">
                                <input class="input is-radiusless is-info" type="text" placeholder="<?php esc_attr_e( 'Register an item name', $this->plugin['text'] ); ?>" value="<?php echo $title; ?>" name="title" id="item-title">
                            </div>
                            <div class="control">
