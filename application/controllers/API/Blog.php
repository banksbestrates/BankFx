...
class Blog extends \Restserver\Libraries\REST_Controller
{
	...
	//get overview blog
	public function get_blog_overview_post()
	{  
        $query = $this->BlogModel->get_blog_overview();
		if ($query['Status']) {
	...
	public function update_blog_overview_post()
	{
		...
		$query = $this->BlogModel->update_blog_overview($data);
