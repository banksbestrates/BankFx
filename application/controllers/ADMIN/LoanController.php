...
class LoanController extends CI_Controller {
    ...
    {     
		...
		$this->load->view('admin_panel/layout/header',array("admin_data"=>$data));
		$this->load->view('admin_panel/loan/student_loan_rates');
		$this->load->view('admin_panel/layout/footer');
    }
    public function personal_loan_rates()
    {     
        $this->check_admin_logged_in();
        $data = array(
            "admin_id"=>$this->admin_id
		...
		$this->load->view('admin_panel/layout/header',array("admin_data"=>$data));
		$this->load->view('admin_panel/loan/personal_loan_rates');
		$this->load->view('admin_panel/layout/footer');
    }
    ...
    {     
		...
		$this->load->view('admin_panel/layout/header',array("admin_data"=>$data));
		$this->load->view('admin_panel/loan/auto_loan_rates');
		$this->load->view('admin_panel/layout/footer');
    }
    ...
    {     
		...
		$this->load->view('admin_panel/layout/header',array("admin_data"=>$data));
		$this->load->view('admin_panel/loan/loan_calculator');
		$this->load->view('admin_panel/layout/footer');
    }
    ...
    {     
		...
		$this->load->view('admin_panel/layout/header',array("admin_data"=>$data));
		$this->load->view('admin_panel/loan/debt_consolidation');
		$this->load->view('admin_panel/layout/footer');
    }
