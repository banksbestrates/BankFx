...
$route['mortgage_downpayment_calculator'] = 'Mortgage/mortgage_downpayment_calculator';
$route['mortgage_income_calculator']  = 'Mortgage/mortgage_income_calculator';
$route['mortgage_payoff_calculator']  = 'Mortgage/mortgage_payoff_calculator';
$route['roth_ira_calculator'] = 'Mortgage/roth_ira_calculator';
$route['mortgage_borrow_calculator'] = 'Mortgage/mortgage_borrow_calculator';
$route['mortgage_refinance_calculator'] = 'Mortgage/mortgage_refinance_calculator';
$route['mortgage_calculator_list'] = 'Mortgage/mortgage_calculator_list';
$route['house_afford'] = 'Mortgage/house_afford';
$route['home_equity_rates'] = 'Mortgage/home_equity_rates';
$route['credit_overview'] = 'Credit/credit_overview';
$route['best_credit_cards'] = 'Credit/best_credit_cards';
$route['balance_transfer'] = 'Credit/balance_transfer';
$route['cash_back'] = 'Credit/cash_back';
$route['bad_credit'] = 'Credit/bad_credit';
$route['low_interest'] = 'Credit/low_interest';
$route['no_annual_fee'] = 'Credit/no_annual_fee';
...
$route['best_large_banks'] = 'Bank/best_large_banks';
$route['best_credit_unions'] = 'Bank/best_credit_unions';
$route['best_online_banks'] = 'Bank/best_online_banks';
$route['best_regional_banks'] = 'Bank/best_regional_banks';

$route['bank_full_review/(:any)'] = 'Bank/bank_full_review/$1';
...
$route['credit_unions/(:any)/(:any)'] = 'Bank/credit_unions/$1/$2';
...
$route['best_cd_rates'] = 'Bank/best_cd_rates';

// loan module
$route['loan_calculator']       = 'Loan/loan_calculator';
$route['amortization_schedule_calculator']       = 'Loan/amortization_schedule_calculator';
$route['saving_goal_calculator']       = 'Loan/saving_goal_calculator';
$route['simple_savings_calculator']    = 'Loan/simple_savings_calculator';
$route['simple_savings_calculator']    = 'Loan/simple_savings_calculator';
...
$route['auto_loan_rates']       = 'Loan/auto_loan_rates';
$route['debt_consolidation']    = 'Loan/debt_consolidation';
$route['student_loan']          = 'Loan/student_loan';
$route['student_loan_rates']    = 'Loan/student_loan_rates';
...
$route['debt_income_ratio_calculator']   = 'Investment/debt_income_ratio_calculator';
$route['income_earned_calculator']       = 'Investment/income_earned_calculator';
$route['interest_paid_life_calculator']  = 'Investment/interest_paid_life_calculator';
$route['college_savings_calculator']     = 'Investment/college_savings_calculator';
$route['compare_saving_rates']           = 'Investment/compare_saving_rates';
...
$route['calculators']               = 'Bank/calculator';
$route['all_calculators']           = 'Calculators/all_calculators';
$route['calculator_detail/(:any)']  = 'Calculators/calculator_detail/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
...
$route['admin/mortgage/mortgage_calculator']    = 'ADMIN/MortgageController/mortgage_calculator';
$route['admin/mortgage/home_equity_rates']      = 'ADMIN/MortgageController/home_equity_rates';
...
$route['admin/loan/personal_loan_rates']        = 'ADMIN/LoanController/personal_loan_rates';
$route['admin/loan/loan_calculator']            = 'ADMIN/LoanController/loan_calculator';
$route['admin/loan/auto_loan']                  = 'ADMIN/LoanController/auto_loan';
$route['admin/loan/auto_loan_rates']            = 'ADMIN/LoanController/auto_loan_rates';
$route['admin/loan/student_loan']               = 'ADMIN/LoanController/student_loan';
$route['admin/loan/student_loan_rates']         = 'ADMIN/LoanController/student_loan_rates';
...
$route['admin/calculator_overview']                   = 'ADMIN/BlogController/blog_overview';
...
$route['api/admin/get_mortgage_calculator_content'] = 'API/Mortgage/get_mortgage_calculator_content';
$route['api/admin/update_mortgage_calculator_content'] = 'API/Mortgage/update_mortgage_calculator_content';
$route['api/admin/get_home_equity_rate_content']    = 'API/Mortgage/get_home_equity_rate_content';
$route['api/admin/update_home_equity_rate_content'] = 'API/Mortgage/update_home_equity_rate_content';
...
$route['api/admin/get_personal_loan_rate_content']   = 'API/Loan/get_personal_loan_rate_content';
$route['api/admin/update_personal_loan_rate_content']= 'API/Loan/update_personal_loan_rate_content';
$route['api/admin/get_loan_calculator_content']     = 'API/Loan/get_loan_calculator_content';
$route['api/admin/update_loan_calculator_content']  = 'API/Loan/update_loan_calculator_content';
$route['api/admin/get_auto_loan']                   = 'API/Loan/get_auto_loan';
$route['api/admin/update_auto_loan']                = 'API/Loan/update_auto_loan';
$route['api/admin/get_auto_loan_rate_content']      = 'API/Loan/get_auto_loan_rate_content';
$route['api/admin/update_auto_loan_rate_content']   = 'API/Loan/update_auto_loan_rate_content';
...
$route['api/admin/get_student_loan_rate_content']   = 'API/Loan/get_student_loan_rate_content';
$route['api/admin/update_student_loan_rate_content']= 'API/Loan/update_student_loan_rate_content';
