                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title">INSURANCE- Home Owner Insurance</h5>                              
                            </div>
                            <small>Web Page Link:<a href="<?php echo base_url();?>homeowner_insurance" target="_blank"><?php echo base_url();?>best_beginner_brokerage<a>                                        
                        </div>  
                        <div class="card-body">             
                            <div class="col-md-12">
