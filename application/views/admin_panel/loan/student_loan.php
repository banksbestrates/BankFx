                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title">LOAN - Student Loan Page</h5>                              
                            </div>
                            <small>Web Page Link:<a href="<?php echo base_url();?>student_loan" target="_blank"><?php echo base_url();?>student_loan<a>                                        
                        </div>  
                        <div class="card-body">             
                            <div class="col-md-12">
...
<script>
   get_loan_inner_page('student_loan')
</script>