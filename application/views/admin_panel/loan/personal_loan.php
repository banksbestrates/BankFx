                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title">LOAN-Personal Loans Page</h5>                              
                            </div>
                            <small>Web Page Link:<a href="<?php echo base_url();?>personal_loan" target="_blank"><?php echo base_url();?>personal_loan<a>                                        
                        </div>  
                        <div class="card-body">             
                        ...
                        <h2 class="px-5 text-dark font-weight-bold">Content Related to Loan</h2><hr/>
                            <div class="col-md-12 px-5">
