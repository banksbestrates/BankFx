                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title">LOAN - Auto Loan Page</h5>                              
                            </div>
                            <small>Web Page Link:<a href="<?php echo base_url();?>auto_loan" target="_blank"><?php echo base_url();?>auto_loan<a>                                        
                        </div>  
                        <div class="card-body">   
