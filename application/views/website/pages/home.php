    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('<?php echo base_url()?>/assets/img/intro-carousel/1.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <a href="<?php echo base_url()?>index.php/bank_overview" class="btn-get-started ">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('<?php echo base_url()?>asssets/img/intro-carousel/4.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item" style="background-image: url('<?php echo base_url()?>asssets/img/intro-carousel/5.jpg');">
            <div class="carousel-container">
              <div class="carousel-content">
