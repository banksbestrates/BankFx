        ...
        <section class="g-brd-top g-brd-gray-light-v4 g-py-10">
            ...
            <div class="container">
                ...
                <div class="d-sm-flex">
                    ...
                    <h2 class="u-heading-v2__title g-mb-10 g-font-weight-800 g-color-black">Debt to Income Ratio Calculator</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 m-0 p-0">
                        <div class="g-brd-around g-brd-yellow g-pa-15 ">
                            ...
                            <div class="form-group g-mb-20">
                                <label class="g-mb-10" for="monthlyDebt">Recurring Montly debt</label>
                                <input id="monthlyDebt" name="monthlyDebt" class="form-control form-control-md rounded-0" type="text" placeholder="$2,000" value="2000" onkeyup="$(this).digits();">
								<span id="monthlyDebttest" style="display: none;"></span>
                                <div id="monthlyDebtSlider1" class="u-slider-v1-3" data-result-container="monthlyDebttest" data-default="2000" data-min="0" data-max="100000"></div>
                            </div>
                            <!-- End Progress Bars -->

                            <!-- Regular Slider Option Two -->
                            <div class="form-group g-mb-20">
                                <label class="g-mb-10" for="grossMonthlyIncome">Gross montly Income</label>
                                <input id="grossMonthlyIncome" name="grossMonthlyIncome" class="form-control form-control-md rounded-0" type="text" placeholder="$6,000" value="6000" onkeyup="$(this).digits();">
								<span id="grossMonthlyIncometest" style="display: none;"></span>
                                <div id="grossMonthlyIncomeSlider1" class="u-slider-v1-3" data-result-container="grossMonthlyIncometest" data-default="6000" data-min="0" data-max="100000"></div>
                            </div>
                            <!-- End Regular Slider Option Two -->
                            <a href="#" class="btn btn-md btn-block u-btn-yellow rounded-0 g-mr-10 g-mb-10" onclick="setDebtIncomeCalculation();">Calculator</a>
                    ...
                    <div class="col-sm-6 col-lg-6 m-0 p-0">
                        <div class="g-brd-around g-brd-yellow g-brd-left-0">
                            <div class="d-flex justify-content-center g-brd-yellow g-pa-40 g-height-300">

                                <div>
                                    <span class="text-nowrap">Debt to income ratio</span>
                                    <h1 class="text-center g-color-blue g-font-weight-800 debtIncomeRatio">0%</h1>
                                </div>
                            </div>
	...
	<script src="<?php echo base_url();?>assets/mortgage_calculator/assets/js/scripts/debt_income_ratio_calculator.js"></script>
